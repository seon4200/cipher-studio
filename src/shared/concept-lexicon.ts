...
export const CONCEPT_LEXICON_V1: readonly ConceptLexiconEntryV1[] = Object.freeze([
  ...
  entry('police officer', 'person', 'openmoji', ['policia', 'policía', 'officer', 'police'], ['law enforcement'], ['security'], ['👮', '👮‍♀️', '👮‍♂️'], ['police'], ['police officer', 'police officer isolated']),
  entry('construction worker', 'person', 'openmoji', ['trabajador', 'trabajadores', 'worker', 'laborer', 'builder', 'obrero'], ['construction worker'], ['labor'], ['👷', '👷‍♀️', '👷‍♂️'], ['user'], ['construction worker', 'worker isolated']),
  entry('woman', 'person', 'openmoji', ['mujer', 'mujeres', 'esposa', 'female', 'lady'], ['person'], ['people'], ['👩', '🧍‍♀️'], ['user'], ['woman', 'woman portrait']),
  entry('man', 'person', 'openmoji', ['hombre', 'hombres', 'esposo', 'male', 'gentleman'], ['person'], ['people'], ['👨', '🧍‍♂️'], ['user'], ['man', 'man portrait']),
  entry('person', 'person', 'openmoji', ['persona', 'personas', 'people', 'gente', 'human'], ['crowd'], ['society'], ['🧍', '👥'], ['user'], ['person', 'people']),
  ...
  entry('mobile phone', 'object', 'openmoji', ['telefono', 'teléfono', 'movil', 'móvil', 'telephone', 'phone', 'smartphone'], ['call'], ['communication'], ['📱', '☎️'], [], ['mobile phone', 'smartphone']),
  entry('scientist', 'person', 'openmoji', ['cientifico', 'científico', 'cientifica', 'científica', 'researcher'], ['laboratory', 'microscope'], ['science'], ['🧑‍🔬', '👩‍🔬', '👨‍🔬'], ['test-tube'], ['scientist', 'scientist laboratory']),
  ...
  entry('artificial intelligence', 'symbol', 'solar', ['inteligencia artificial', 'ia', 'ai'], ['machine learning', 'neural network', 'brain technology'], ['technology'], ['🧠', '🤖'], ['brain', 'cpu'], ['artificial intelligence', 'ai technology', 'brain technology']),
  entry('writing', 'object', 'openmoji', ['escribir', 'escritura', 'typing', 'redactar'], ['keyboard', 'document', 'text'], ['communication'], ['⌨️', '✍️', '📝'], ['pen'], ['typing keyboard', 'writing']),
